...
require (
	...
	github.com/blang/semver/v3 v3.6.1
...
replace github.com/mvdan/unparam v0.0.0-20190124213536-fbb59629db34 => github.com/mvdan/unparam v0.0.0-20190209190245-fbb59629db34
